...
{
    public function index(Request $request, Threshold $Thresholds)
    {
    ...
    public function store(ThresholdsRequest $request, Threshold $Thresholds)
    {
    ...
    {
        $Thresholds = Threshold::findOrFail($id);
